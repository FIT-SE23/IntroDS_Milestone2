...
In detail, the procedure combines the following steps:
   ...
   \label{eq:cmz}
   \end{equation} 
   with $B = -0.101 +0.026 \, z$ and $A = 0.520 +(0.905-0.520) \exp(-0.617 z^{1.21})$ \citep{dutton14}, alternative forms can be considered \citep[e.g.,][]{bha13,lud16}, and the conversion from $M_{200}$ to $M_{500}$ is obtained through an interaction and assuming a Navarro, Frenk \& White \citep{nfw97} profile;
