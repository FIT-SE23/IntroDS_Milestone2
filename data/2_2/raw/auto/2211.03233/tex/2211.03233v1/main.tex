...
\begin{figure}[H]
    \centering
     \makebox[\textwidth]{\includegraphics[width=15cm]{figures_miguel/AdamModel_test.pdf}} 
...
\begin{figure}[H]
    \centering
     \makebox[\textwidth]{\includegraphics[width=15cm]{figures_miguel/OptunaModel_test.pdf}}
