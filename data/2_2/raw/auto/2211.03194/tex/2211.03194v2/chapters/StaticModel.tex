...
As observed by \citefulls{Marcotte04}, this definition has the drawback of admitting
...
\begin{definition} (Bernstein and Smith~\cite[Def. 2.]{BernsteinS94})\label{def:BS}
...
Following \citefulls{CorreaCapEqInStaticFlows}, the definition of BS-equilibrium can be rephrased as ``no arbitrarily small bundle of drivers on a common path can strictly decrease its cost by switching to another path''. 
