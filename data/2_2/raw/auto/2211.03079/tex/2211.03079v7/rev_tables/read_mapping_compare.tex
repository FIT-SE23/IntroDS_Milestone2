\begin{table}[H]
\setcounter{table}{1}
 \caption{Read mapping comparison of \mech with baseline basecallers in terms of mean length of individual sequencing reads in a dataset (Avg. Length), the total number of mapped reads (Mapped Reads), the total number of mapped bases (Mapped Bases), and the ratio of total number of mapped reads and the number of mapped bases.}
