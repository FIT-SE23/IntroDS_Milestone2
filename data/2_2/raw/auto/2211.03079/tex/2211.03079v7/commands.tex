...
\newcommand{\gp}{{\texttt{Bonito\_CRF-sup}}\xspace}
\newcommand{\gpf}{{\texttt{Bonito\_CRF-fast}}\xspace}
\newcommand{\bon}{{\texttt{Bonito\_CTC}}\xspace}
\newcommand{\dor}{\texttt{Dorado-fast}\xspace}
\newcommand{\sac}{\texttt{SACall}\xspace}
...
% \newcommand\ltitle{RUBICON: a framework for designing efficient\\ deep learning-based genomic basecallers}
\newcommand\ltitle{RUBICON: A Framework for Designing Efficient \\Deep Learning-Based  Genomic Basecallers}
...
% \author{Gagandeep Singh$^{a,b}$ \hspace{0.5cm}  Mohammed Alser$^{b}$ \hspace{0.5cm}    Kristof Denolf$^a$ \\  Can Firtina$^b$   \hspace{0.5cm} Alireza Khodamoradi$^{a}$ \hspace{0.5cm}  Meryem Banu Cavlak$^b$ \\ Henk Corporaal$^c$ \hspace{0.5cm} Onur Mutlu$^b$
% \\\vspace{-0.4cm} \normalsize $^a$AMD Research\hspace{1cm} $^b$ETH Z{\"u}rich   \hspace{1cm}   $^c$Eindhoven University of Technology\vspace{0.4cm}}

\author{Gagandeep Singh$^{a,c}$ \hspace{0.5cm}  Mohammed Alser$^{a}$ \hspace{0.5cm}    Kristof Denolf$^c$ \\  Can Firtina$^{a,*}$   \hspace{0.5cm} Alireza Khodamoradi$^{c}$ \hspace{0.5cm}  Meryem Banu Cavlak$^a$ \\ Henk Corporaal$^b$ \hspace{0.5cm} Onur Mutlu$^{a,*}$
% \\\vspace{-0.4cm} \normalsize $^a$AMD Research\hspace{1cm} $^b$ETH Z{\"u}rich   \hspace{1cm}   $^c$Eindhoven University of Technology\vspace{0.4cm}}
\\ \normalsize$^a$Department of Information Technology and Electrical Engineering, ETH Z{\"u}rich, Switzerland  \\\normalsize $^b$Department of Electrical Engineering, Eindhoven University of Technology, The Netherlands \\\normalsize $^c$Research and Advanced Development, AMD, USA}



% \newcommand{\hy}[2][yellow!50]{{%
%     \colorlet{foo}{#1}%
%     \sethlcolor{foo}\hl{#2}}%
% }

\newcommand{\hgb}[1]{{\color{black}{#1}}}
% \newcommand{\hgb}[2][yellow!50]{{%
%     \colorlet{foo}{#1}%
%     \sethlcolor{foo}\hl{#2}}%
% }
\newcommand{\hy}[1]{{\color{black}{#1}}}
\newcommand{\yboxbegin} {
	\begin{tcolorbox}[enhanced, frame hidden, colback=yellow!50, breakable]
}
...
\newcommand{\gbwriting}[1]{{\color{black}{#1}}}
\newcommand{\rmpSpeedupCC}{{364.89}$\times$\xspace}
\newcommand{\rmpSpeedupCRF}{{14.25}$\times$\xspace}
\newcommand{\rmpSpeedupBonCTC}{{128.13}$\times$\xspace}
\newcommand{\rmpSpeedupSAC}{{81.58}$\times$\xspace}
\newcommand{\rmpSpeedupDor}{{3.77}$\times$\xspace}
\newcommand{\rmpSpeedupFP}{{50.15}$\times$\xspace}
\newcommand{\rmpSpeedupSUP}{{185.54}$\times$\xspace}


\newcommand{\rfpSpeedupCC}{{7.28}$\times$\xspace}
\newcommand{\rfpSpeedupBonCTC}{{2.56}$\times$\xspace}
\newcommand{\rfpSpeedupSAC}{{1.63}$\times$\xspace}

\newcommand{\rmpAccCC}{{5.23}\%\xspace}
\newcommand{\rmpAccDor}{{2.85}\%\xspace}
\newcommand{\rmpAccCRF}{{2.89}\%\xspace}
\newcommand{\rmpAccBonCTC}{{0.06}\%\xspace}
\newcommand{\rmpAccSAC}{{1.97}\%\xspace}

\newcommand{\rmpAccSUP}{{2.47}\%\xspace}
...
\newcommand{\sref}[1]{\color{black}{\textbf{\ref{#1}~\nameref{#1}}}}

% \newcommand{\reff}[1]{Eq.(\ref{#1})}
\newcommand{\ogb}[1]{{\color{black}{#1}}}

\newcommand{\fgb}[1]{{\color{black}{#1}}}