...
% }
\author{Gagandeep Singh$^{a,b}$ \hspace{0.5cm}  Mohammed Alser$^{b}$ \hspace{0.5cm}  Alireza Khodamoradi$^{a}$ \\  Kristof Denolf$^a$ \hspace{0.5cm}  Can Firtina$^b$ \hspace{0.5cm}  Meryem Banu Cavlak$^b$ \\ Henk Corporaal$^c$ \hspace{0.5cm} Onur Mutlu$^b$
