...
\begin{document}
	...
	\begin{figure*}[ht]
		\center
		\includegraphics[width=13.5cm]{Fig1-SEM-Light-2k} 
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\linewidth]{Fig2-KOS-FMR.png}
	...
	\begin{figure*}[ht]
		\center
		\includegraphics[width=0.8\linewidth]{Fig3-CoAg-IP-FMR.pdf} 
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.98\linewidth]{Fig4-SimdotSpectra2}
	...
	\begin{figure}[t!]
		\centering
		\includegraphics[width=0.98\linewidth]{Fig5-fHvarsim1}
	...
	\begin{figure*}
		\centering
		\includegraphics[width=0.7\textwidth]{Fig6-CoAg-OOP-FMR.pdf}
	...
	\begin{table*}
		...
		\begin{ruledtabular}
			\begin{tabular}{lccccc}
				...
				Parameter & Uniform mode & PSSW mode 1 & Exchange mode & PSSW mode 1 & PSSW mode 2\\		 
	...
	In the out-of-plane (OOP) geometry, the $f(H)$ dependence shown in Fig.~\ref{fig:OOP-FMR} was measured in field-sweep mode as $f$ was gradually increased from 0.5 GHz to 40 GHz in steps of \SI{0.5}{\GHz}, while the dc magnetic field $H_\textrm{dc}$, applied perpendicular to the sample plane, was swept from 0 T to 2.2 T. 
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.98\linewidth]{Fig7-OOP-Sim-FMR-Cleaned.pdf}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.98\linewidth]{Fig8-NewSimOOP1-NoFrame.pdf}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.477\textwidth]{Fig9-CoAg-Azimuthal.pdf}
	...
	\begin{figure*}[ht]
		\centering
		\includegraphics[width=0.7\textwidth]{Fig10-CoAg-Polar-NewColors.pdf}
	...
	\begin{figure*}[ht]
		\centering
		\includegraphics[width=0.9\textwidth]{Fig11-Damping.pdf}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.48\textwidth]{Fig12-fHvarsimpure}
	...
	\begin{figure*}[ht]
		\centering
		\includegraphics[width=0.85\textwidth]{Fig13-Theor}
	...
	\begin{figure*}[ht]
		\centering
		\includegraphics[width=0.90\textwidth]{Fig14-p=1modes}
	...
	\pagebreak
	\bibliography{Nanodots_PhysRevAppl_v1.bib}
