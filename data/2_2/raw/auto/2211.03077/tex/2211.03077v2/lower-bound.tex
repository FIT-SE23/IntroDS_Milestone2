...
Next we prove that the logarithmic dependence on the balance ratio or the impartiality ratio is necessary.
...
Hence, we may assume without loss of generality that agent $i$ receives the least amount of item $t = i$ among agents $i$ to $N$ in the algorithm's allocation.
