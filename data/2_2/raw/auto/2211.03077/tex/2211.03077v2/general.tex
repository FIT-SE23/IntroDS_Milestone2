...
\begin{algorithm}[t] 
    \caption{\textbf{Greedy with Rounded Values}\ (for $\mu$-impartial instances)}
...
\begin{algorithm}[t]
    \caption{\textbf{Greedy with Rounded Values}\ (for  instances with unknown impartiality ratio)}
