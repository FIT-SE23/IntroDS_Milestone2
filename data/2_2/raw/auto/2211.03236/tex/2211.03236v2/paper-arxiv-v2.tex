...
\begin{equation}
\rho_\phi(z<z_c) \simeq \frac{1}{2}m^2 \phi_i^2\left(\frac{1+z}{1+z_c}\right)^{3}=0.005\left(\frac{\phi_i}{M_{Pl}}\right)^2 \left(\frac{1+z}{1100}\right)^3 ~{\rm eV}^4~,
\label{rhophi}
\end{equation}
...
We thank Lloyd Knox for helpful discussion. This work was supported by the Department of Energy grant DE-AC02-07CH11359 subcontract 6749003 at Fermilab and the University of Chicago. JF also acknowledges the hospitality of the Aspen Center for Physics, supported by NSF grant PHY-1607611, where part of this work was carried out.
