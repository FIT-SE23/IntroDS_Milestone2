...
\caption{A visualization example of parsed logical structure on an explanation and \model{}'s reasoning evidence on an input from CLUES dataset.
The blue font and green background indicate two attributes (``higher safety'' and ``capacity'') involved in this example.
% \zhenhailong{\sout{add a brief description of the task/dataset this example comes from?}}
% \zhenhailong{\sout{add description of the meaning of the text color and the background color?}} \yi{where is this table referenced in this page?}
% \chihan{oh it is in page 6-7 actually. I agree the figure is better repositioned.}
}
\vspace{-4mm}
