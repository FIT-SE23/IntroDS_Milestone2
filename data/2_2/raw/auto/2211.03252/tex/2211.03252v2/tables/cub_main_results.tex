...
\toprule
% \textbf{CUB-Explanations}
& \textbf{Model} & $ACC_U$ & $ACC_S$ & $ACC_\textbf{H}$ \\
\midrule

\multirow{2}{20mm}{w/o VLPMs}
...
\vspace{-2mm}
\caption{Generalized zero-shot classification results (in percentage) on CUB-Explanations dataset.
