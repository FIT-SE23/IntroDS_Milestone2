...
There are several future directions to be explored. The most intriguing one is how to utilize pre-trained generative language models for explicit logical reasoning
% , as pre-trained language models have been shown capable of planning~\citep{DBLP:conf/icml/HuangAPM22}
. 
Another direction is to incorporate semantic reasoning ability in our approach, such as reasoning on entity relations or event roles.