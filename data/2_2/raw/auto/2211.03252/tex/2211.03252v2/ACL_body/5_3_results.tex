...
Results are listed in Table~\ref{tab:cub_main_results}
% and Table~\ref{tab:ecthr_main_results}
. On CUB-Explanations \model{} achieves the highest $ACC_U$ and $ACC_\textbf{H}$ both with and without pre-trained vision-language parameters.
