...
\newcommand\hnote[1]{\textcolor{red}{[Wang]: #1}}
%
...
\pdfinfo{
/Title The Enforced Transfer: An Instance-Based Divide-and-Conquer Domain Adaptation Algorithm
...
\title{MiddleGAN: Generate Domain Agnostic Samples for Unsupervised Domain Adaptation}

%\author{Anonymous Author(s)}
%\affiliations{Anonymous Institute(s)}

\author{
    %Authors
    % All authors must be in the same font size and format.
    Ye Gao\textsuperscript{\rm 1},
    Zhendong Chu \textsuperscript{\rm 1},
    Hongning Wang \textsuperscript{\rm 1},
    John Stankovic \textsuperscript{\rm 1}
}
\affiliations{
    %Afiliations
    \textsuperscript{\rm 1}Department of Computer Science, University of Virginia, Charlottesville, United States}
    
%    \textsuperscript{\rm 2}Department of Psychology, University of Utah, Salt Lake City, United States\\
    
%    \textsuperscript{\rm 3}College of Nursing, Ohio State University, Columbus, United States\\
    
%    \textsuperscript{\rm 4}Department of Psychology, University of Tennessee, Knoxville, United States\\
...
\input{LaTeX/2_related_works}
\input{LaTeX/3_middleGAN}
\input{LaTeX/4_evaluation}
%\input{LaTeX/5_discussion}
\input{LaTeX/6_conclusion}
%\input{LaTeX/7_checklist}
%\input{8_appendix}
