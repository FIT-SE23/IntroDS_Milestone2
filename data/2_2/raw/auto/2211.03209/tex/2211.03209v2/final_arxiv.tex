...
\title{Robust Decentralized Secondary Control Scheme \\ for Inverter-based Power Networks}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The simulation test system comprised of a microgrid (MG) with four GFM-inverters, a fixed load, and a variable large load. Lines connecting the inverters are modelled with impedances $Z_{Li}$. The single line diagram of the MG setup is shown in Figure~\ref{fig:testbed} and nominal values of the modeled MG components are provided in Table~\ref{table_1}. An averaged model of GFM inverters was used \cite{GFM_models}, and each inverter had the same LCL filter at its output stage with $(L_{f}, C_{f})$ defined in Table~\ref{table_1}. The inverters were programmed to operate in droop control mode with inner current and outer voltage control loops \cite{GFM_models}. 
...
\begin{figure}[h!]
\centering
\includegraphics[width=1.0\linewidth]{ACC_all4_freqs_together_Kt0.25.eps}
\vspace{-10pt}
...
\begin{figure}[h!]
\centering
\includegraphics[width=1.0\linewidth]{ACC_all4_Ps_together_Kt0.25.eps}
\vspace{-10pt}
...
\begin{figure}[h!]
\centering
\includegraphics[width=1.0\linewidth]{ACC_sweep_Kt,Ks1000,PCCfreq_1inv.eps}
\vspace{-10pt}
...
\begin{figure}[h!]
\centering
\includegraphics[width=1.0\linewidth]{ACC_sweep_Kt,Ks1000,Ps_1inv.eps}
\vspace{-10pt}
...
\begin{figure}[h!]
\centering
\includegraphics[width=1.0\linewidth]{ACC_sweep_Ks,Kt0.25,PCCfreq_1inv.eps}
\vspace{-10pt}
...
\begin{figure}[h!]
\centering
\includegraphics[width=1.0\linewidth]{ACC_sweep_Ks,Kt0.25,Ps_1inv.eps}
\vspace{-10pt}
