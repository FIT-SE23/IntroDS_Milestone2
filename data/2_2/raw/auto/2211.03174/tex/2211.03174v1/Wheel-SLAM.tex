...
\begin{figure}[t]
	\centering
	\includegraphics[width=7cm]{Wheel-IMUInstallation_2022.png}
...
Because the Wheel-IMU rotates with the wheel, the pitch of the robot is unknown in Wheel-INS. In other words, we cannot determine the robot ascent and descent in Wheel-INS. Therefore, it is assumed that the robot is moving on a horizontal plane. However, experimental results \cite{niu2021} illustrated that this assumption does not cause significant navigation error. 
...
Wheel-SLAM uses a PF to estimate the robot trajectory distribution. For each particle, the individual trajectory-based terrain map are independent to each other. As a result, every particle is composed of a robot pose and a terrain map; thus, the \textit{i}-th particle at time \textit{t} can be represented as
\begin{equation}
...
The first step is to generate new pose for each particle by sampling from the robot probabilistic motion model:
\begin{equation}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=7cm]{expplatform_2022_RAL.png}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=7cm]{alltrajs_2022.png}
	\caption{Experimental trajectories. Seq. 1, Seq. 2, and Seq. 3 are circular trajectories where the vehicle moved several times in one direction while Seq. 4 and Seq. 5 are more complicated ones where the vehicle moved with different directions (not just turn around in one direction) in large-scale environments.}
	\label{figtraj}
\end{figure}
...
\begin{figure}[!t]
	\begin{tabular}{cc}
		\begin{minipage}[t]{0.5\linewidth}
			...
			\includegraphics[height = 0.65\linewidth]{1trajcomp.png}
		}
		\end{minipage}
		\begin{minipage}[t]{0.5\linewidth}
		    \centering
			\subfigure[Horizontal positioning and heading errors in Seq. 1.]{
			\includegraphics[height = 0.65\linewidth]{1err_2022.png}
		}
		\end{minipage}
	\end{tabular}
	...
	\begin{tabular}{cc}
		\begin{minipage}[t]{0.5\linewidth}
			...
			\subfigure[Estimated trajectories against ground truth in Seq. 2.]{
				\includegraphics[height = 0.65\linewidth]{2trajcomp.png}
			}
		\end{minipage}
		\begin{minipage}[t]{0.5\linewidth}
		    \centering
			\subfigure[Horizontal positioning and heading errors in Seq. 2.]{
				\includegraphics[height = 0.65\linewidth]{2err_2022.png}
			}
		\end{minipage}
	\end{tabular}
	...
	\begin{tabular}{cc}
		\begin{minipage}[t]{0.5\linewidth}
			...
			\subfigure[Estimated trajectories against ground truth in Seq. 3.]{
				\includegraphics[height = 0.65\linewidth]{3trajcomp.png}
			}
		\end{minipage}
		\begin{minipage}[t]{0.5\linewidth}
		    \centering
			\subfigure[Horizontal positioning and heading errors in Seq. 3.]{
				\includegraphics[height = 0.65\linewidth]{3err_2022.png}
			}
		\end{minipage}	
	\end{tabular}	
	...
	\begin{tabular}{cc}
		\begin{minipage}[t]{0.5\linewidth}
			...
			\subfigure[Estimated trajectories against ground truth in Seq. 4.]{
				\includegraphics[height = 0.65\linewidth]{4trajcomp.png}
			}
		\end{minipage}
		\begin{minipage}[t]{0.5\linewidth}
		    \centering
			\subfigure[Horizontal positioning and heading errors in Seq. 4.]{
				\includegraphics[height = 0.65\linewidth]{4err_2022.png}
			}
		\end{minipage}
	\end{tabular}
	...
	\begin{tabular}{cc}
		\begin{minipage}[t]{0.5\linewidth}
			...
			\subfigure[Estimated trajectories against ground truth in Seq. 5.]{
				\includegraphics[height = 0.65\linewidth]{5trajcomp.png}
			}
		\end{minipage}
		\begin{minipage}[t]{0.5\linewidth}
		    \centering
			\subfigure[Horizontal positioning and heading errors in Seq. 5.]{
				\includegraphics[height = 0.65\linewidth]{5err_2022.png}
			}
		\end{minipage}
	\end{tabular}
...
\begin{figure*}[t]
	\centering
	\includegraphics[width=13.5cm]{rollmap_2022.png}
	\caption{The terrain maps estimated by Wheel-SLAM in Seq. 1, Seq. 2, and Seq. 4, respectively. The colors represents the values of the road bank angles. The larger the road bank angle, the lighter the color.}
	\label{figrollmap}
\end{figure*}
