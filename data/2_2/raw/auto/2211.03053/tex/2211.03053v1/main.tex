...
\name{Zecheng Wang, Yik-Cheung Tam}
...
N/A (baseline)         & MiniLM     & 5.43   & 7.94 \\ %    & 100
\hline
%Multiqa-MiniLM            & No initialization     & 5.32 &  8.17    & 72   \\ 
%All-MiniLM & No initialization & 5.34 & 8.10 & 63\\
Multiqa-MiniLM           & Multiqa-MiniLM      & 5.05   & 7.52  \\   %& 63   \\ 
Multiqa-MiniLM            & MiniLM      & 5.04   & 7.47     \\ % & 62   \\ 
All-MiniLM          & All-miniLM      & \textbf{5.02}   &   7.44 \\ %  & 145  \\
All-MiniLM          & MiniLM      & 5.04   &   \textbf{7.37}  \\ % &  \text{131}\\
\hline
\end{tabular}%}
\label{table:small}
\end{table}
...
\begin{tabular}{|c|c|c|c|}
\hline
ST weight     & LM weight     & Val. ppl    & Test ppl      \\ %   & Epochs \\
\hline
N/A (baseline)      & BERT-base     & 5.19   & 7.58  \\ %  & 38  \\
\hline
...
N/A (baseline)           & RoBERTa-base      & 5.35   & 7.69 \\ %     & 42  \\
N/A (baseline)           & GPT2-base     & {\bf 5.01}   & 7.60   \\ %  & 71  \\
\hline


All-distilroberta           & RoBERTa-base      & 5.13   &   7.55  \\ % & 26   \\ 
Multiqa-distilbert           & RoBERTa-base      & 5.12   &   7.54  \\ % & 26   \\ 
Multiqa-mpnet          & GPT2-base      & 5.03   &  7.37  \\ %    & 22  \\
Multiqa-distilbert         & GPT2-base      &  5.03  &  7.37  \\ % & 22 \\
All-distilroberta         & GPT2-base      & 5.03   & {\bf 7.36}  \\ %   & 22 \\
%Multiqa-distilbert            & BERT-base     & \textbf{4.88} &  \textbf{7.04}    & \textbf{18}  \\ 
