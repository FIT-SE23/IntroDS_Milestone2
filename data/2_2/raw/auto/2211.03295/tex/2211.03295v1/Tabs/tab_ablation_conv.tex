...
\begin{tabular}{l|ccc}
    ...
    \vspace{-0.5em}
    \caption{Ablation of multi-order DWConv layers in the proposed $\mathrm{Moga}(\cdot)$ module. The baseline adopts the MogaNet framework using the non-linear projection, $\mathrm{DW}_{5\times 5}$, and the SiLU gating branch as $\mathrm{SMixer}(\cdot)$ and using the vanilla MLP as $\mathrm{CMixer}(\cdot)$.}
