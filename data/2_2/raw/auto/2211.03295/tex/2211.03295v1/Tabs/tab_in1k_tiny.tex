...
\begin{tabular}{llcccc}
    ...
    RegNetY-400MF~\cite{cvpr2020regnet}              & CVPR'2020    & $224^2$ & 5.3    & 0.40  & 74.1      \\
    RegNetY-800MF~\cite{cvpr2020regnet}              & CVPR'2020    & $224^2$ & 6.3    & 0.80  & 76.3      \\ \hline
    DeiT-T~\cite{icml2021deit}                       & ICML'2021    & $224^2$ & 5.7    & 1.08  & 72.2      \\
    % DeiT-2G~\cite{icml2021deit}                      & ICML'2021    & $224^2$ & 13.2   & 1.90  & 75.1      \\
    ...
    ViT-C~\cite{nips2021vitc}                        & NIPS'2021    & $224^2$ & 4.6    & 1.10  & 75.3      \\
    SReT-T$_{Distill}$~\cite{eccv2022SReT}           & ECCV'2022    & $224^2$ & 4.8    & 1.10  & 77.6      \\ \hline
    ...
    Swin-1G~\cite{liu2021swin}                       & ICCV'2021    & $224^2$ & 7.3    & 1.00  & 77.3      \\
    % Swin-2G~\cite{liu2021swin}                       & ICCV'2021    & $224^2$ & 12.8   & 2.00  & 79.3      \\
    ...
    \rowcolor{gray94}\bf{MogaNet-XT}                 & Ours         & $224^2$ & 3.0    & 0.80  & 76.5      \\
    \rowcolor{gray94}\bf{MogaNet-T}                  & Ours         & $224^2$ & 5.2    & 1.10  & 79.0      \\
    \rowcolor{gray94}\bf{MogaNet-T}                  & Ours         & $256^2$ & 5.2    & 1.44  & 79.6      \\
    \rowcolor{gray94}\bf{MogaNet-T}$^\S$             & Ours         & $256^2$ & 5.2    & 1.44  & \bf{80.0} \\
    \bottomrule
    \end{tabular}
    }
    \vspace{-0.5em}
    \caption{\textbf{ImageNet-1K classification} performance of lightweight (around 5M parameters) models. \small{$\dag$} and \small{$\S$} denote using RSB A2 \cite{wightman2021rsb} setting for ConvNets and the refined setting for MogaNet.}
