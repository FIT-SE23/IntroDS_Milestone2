...
\newcommand{\ssr}[1]{{\footnotesize  \textbf{ \textcolor{violet}{ [#1 --SS]}}\normalsize}}

\newcommand{\vg}[1]{{\footnotesize  \textbf{ \textcolor{cyan}{ [#1 --VG]}}\normalsize}}

\newcommand{\jb}[1]{{\footnotesize  \textbf{ \textcolor{green!50!black}{ [#1 --JB]}}\normalsize}}
...
\[
P_{\textbf{w},b} := \{x \in \{-1,+1\}^k: \textbf{w} \cdot x = b\},
\quad Q_{\textbf{w},b} := \{-1,+1\}^k \setminus \{\sgn(\textbf{w}), -\sgn(\textbf{w}\})
\]
...
Note that 
\begin{align*}
\norm{ \textbf{u}_i - \textbf{c} }_2^2 &=  \norm{\textbf{u}_i}_2^2 + \norm{\textbf{c}}_2^2 - 2 \textbf{c} \cdot \textbf{u}_i \\ 
