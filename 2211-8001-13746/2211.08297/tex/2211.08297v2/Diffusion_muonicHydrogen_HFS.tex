...
\end{eqnarray}
%
where $R_\upmu=500$~1/s is the muon trigger rate in the entrance detector (limited by the laser repetition rate) and $\varepsilon_\text{Au}$ is the detection efficiency for a $\upmu$Au event.
