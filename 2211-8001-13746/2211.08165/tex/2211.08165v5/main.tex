...
\begin{figure*}
  \centering
  \subfloat{\def\svgwidth{.42\textwidth}\tiny\input{pdftex/break_sym_q.pdf_tex}}\hfill
  \subfloat{\def\svgwidth{.29\textwidth}\tiny\input{pdftex/break_sym.pdf_tex}}\hfill
  \subfloat{\def\svgwidth{.27\textwidth}\tiny\input{pdftex/surface.pdf_tex}}
