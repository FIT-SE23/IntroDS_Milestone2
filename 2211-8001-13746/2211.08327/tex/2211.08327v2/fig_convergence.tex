...
\caption{The performance in objective maximization and convergence is evaluated over $50$ independent simulations. The 90\% confidence interval is plotted for each curve. The setup $|\KK|=50$ is used throughout \ref{fig:dep-dep-k20}--\ref{fig:dep-dep-k50}. The y-axis is the sum-rate over all links in $\KK$.}
