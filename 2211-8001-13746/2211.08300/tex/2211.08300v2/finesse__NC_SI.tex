...
\alsoaffiliation[Monash University]
...
%\altaffiliation{A shared footnote}
\affiliation[University of Santiago de Chile]
...
\vspace{0.3cm}
Note that the PL for TDBC-doped PVA peaks at a lower energy ($\sim$2.10 eV) than the TDBC produced using the layer-by-layer technique ($\sim$2.13 eV). Note also that for the TDBC-doped PVA on Au coated Si, the low energy shoulder of the TDBC PL is enhanced in relative strength. This is consistent with a recent observation based on squarine dyes~\cite{Quenzel_ACSNano_2022_16_4693}
...
\noindent 2) Thomas \textit{et al.}~\cite{Thomas_JPCL_2021_12_6914}. The numbers we extracted from this work for inclusion in the present manuscript here are: %$\Omega_R=0.50\pm0.01$ eV, FSR = 1.2$\pm0.1$ eV, $\omega_0=2.2$ eV, $K=0.46\pm0.01$ eV, $\Gamma=0.36\pm0.01$ eV. These lead to a value for the finesse of $\mathcal{F} = 7.2\pm0.4$, and a value for $2\Omega_R/(\Gamma+K)$ of 1.49 $\pm0.2$.\\
$\Omega_R=0.59\pm0.03$ eV, FSR = 1.2$\pm0.1$ eV, $\omega_0=2.2$ eV, $K=0.46\pm0.01$ eV, $\Gamma=0.36\pm0.01$ eV. These lead to a value for the finesse of $\mathcal{F} = 2.6\pm0.4$, and a value for $2\Omega_R/(\Gamma+K)$ of 1.4 $\pm0.2$.\\

\noindent 3) Vasista \textit{et al.}~\cite{Vasista_NL_2020_20_1766}. The numbers we extracted from this work for inclusion in the present manuscript here are: $\Omega_R=0.094\pm0.01$ eV, FSR = 0.08$\pm0.01$ eV, $\omega_0=2.13$ eV, $K=0.02\pm0.005$ eV, $\Gamma=0.11\pm0.01$ eV. These lead to a value for the finesse of $\mathcal{F} = 2.6\pm1.1$, and a value for $2\Omega_R/(\Gamma+K)$ of 2.9 $\pm0.3$.\\

\noindent 4) Thomas \textit{et al.}~\cite{Thomas_Science_2019_363_615}. The numbers we extracted from this work for inclusion in the present manuscript here are: $\Omega_R=60\pm5$ cm$^{-1}$, FSR = 420$\pm10$  cm$^{-1}$ $\omega_0=842$ cm$^{-1}$, $K=70\pm5$ cm$^{-1}$, $\Gamma=28\pm2$ cm$^{-1}$. These lead to a value for the finesse of $\mathcal{F} = 8.3\pm0.2$, and a value for $2\Omega_R/(\Gamma+K)$ of 3.0 $\pm0.2$.\\ 

\noindent 5) Ahn \textit{et al.}~\cite{Ahn_Science_2023_380_6650}. The numbers we extracted from this work for inclusion in the present manuscript here are: $\Omega_R=73\pm6$ cm$^{-1}$, FSR = 480$\pm10$  cm$^{-1}$ $\omega_0=2260$ cm$^{-1}$, $K=28\pm6$ cm$^{-1}$, $\Gamma=47\pm1$ cm$^{-1}$. These lead to a value for the finesse of $\mathcal{F} = 8.3\pm0.2$, and a value for $2\Omega_R/(\Gamma+K)$ of 3.0 $\pm0.2$.\\

\section{Microcavity PL with Finite Finesse}\label{app:PL theory}
