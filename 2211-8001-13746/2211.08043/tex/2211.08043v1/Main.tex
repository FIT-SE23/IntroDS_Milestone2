...
\usepackage[margin=1.5in,bottom=1.5in]{geometry}		% for tighter margins (80 CPL)
...
%% Environment end
%----------------------------------------------------------------------
\def\endenv{\hfill{\small$\lozenge$}\medskip}
...
{On the rate of convergence of Bregman proximal methods\\
in constrained variational inequalities}		% for long title
