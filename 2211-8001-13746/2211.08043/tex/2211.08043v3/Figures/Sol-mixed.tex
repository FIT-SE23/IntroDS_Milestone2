...
\draw [edgestyle, thick, DualColor] (sol.center) -- ++(\upangle+90:\conescale*\unit) node [near end,above right] {$\ncone(\sol)$};
...
%\vphantom{%
\vphantom{
\fill [DualColor!5] (P3)++(\upangle+90:\conescale*\unit) -- (P3) --++(\downangle+30:\conescale*\unit);
}
%\fill [DualColor!5] ($(P3) + (\upangle:\conescale*\unit)$)++(\upangle+90:\conescale*\unit) -- ($(P3) + (\upangle:\conescale*\unit)$) --++(\downangle+30:\conescale*\unit);
