...
\begin{itemize}
    ...
    \item The bias and its scatter are influenced by the radii within which the bias is estimated, i.e. $R_{2500}, R_{500}$ and $R_{200}$ in this work. The largest bias is at $R_{200}$ (almost 20\%), while at $R_{500}$ and $R_{200}$, the median value is around 10\%.
