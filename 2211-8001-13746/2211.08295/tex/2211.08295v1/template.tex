...
\section{Background}
Significant advancements have been made in the field of Natural Language processing by using neural networks. Problems that were thought to have no or extremely difficult solutions such as sarcasm detection have been solved with deep learning \cite{b8}. In order to understand the architecture proposed in this paper, a review of the following concepts is necessary.
...
\bibitem{b8} Mandal, P.K. and Mahto, R., 2019. Deep CNN-LSTM with word embeddings for news headline sarcasm detection. In 16th International Conference on Information Technology-New Generations (ITNG 2019) (pp. 495-498). Springer, Cham.
