...
$d+1$ decomposition is ubiquitous in formulating the time evolution of tensor field theories in curved spece, and highlights the constrained nature of the dynamics of the vector fields. This likely played a role in the misidentification of the constraint as the culprit of a physical breakdown. Nevertheless, we expect the results of the existing studies that used the constraint criterion to be essentially valid in that the time evolution indeed breaks down in their examples, even though it occurs at a different spacetime point which may or may not be covered in the computation.
