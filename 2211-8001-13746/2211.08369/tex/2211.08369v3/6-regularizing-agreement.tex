...
Now that we know on which instance categories models tend to disagree on, our next goal is to attempt to fix these disagreements.
...
To alleviate these issues, we leverage two methods that have been shown to improve the faithfulness of attention-based explanations in conicity \cite{mohankumar2020towards} and tying \cite{tutek2020staying}.
\josip{maybe drop the first part?}
