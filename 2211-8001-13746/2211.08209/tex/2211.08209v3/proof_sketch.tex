...
\begin{align}
    \loss^{(i)}\bigparenth{\ExternalFieldI} & \geq  \loss^{(i)}\bigparenth{\TrueExternalFieldI} + R^2(\varepsilon, \delta) \stext{when} n \geq \frac{ce^{c'\bGM} p^4}{\varepsilon^4}  \Bigparenth{p \log \frac{p^2}{\delta \varepsilon^2}  + \tmetric_{\ExternalField,n}\normalparenth{ \varepsilon, \delta}}, \label{eq_secondstage_key_step}
\end{align}
