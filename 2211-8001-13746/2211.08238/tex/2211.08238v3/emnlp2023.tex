...
\textbf{Luu Anh Tuan$^4$, Yi Yang$^{1}$ and Fei Wu$^{156*}$}\\
...
The purpose of contrastive learning~\cite{DBLP:conf/cvpr/ChopraHL05} is to make similar examples closer together and dissimilar examples further apart in the feature space. Contrastive learning has been widely explored for self-supervised/unsupervised representation learning~\cite{wu2018unsupervised,hjelm2018learning,bachman2019learning,chen2020simple,he2020momentum,nguyen2021contrastive,wu2022mitigating}. Recently, several studies have extended contrastive learning to supervised settings~\cite{gunel2020supervised,khosla2020supervised,suresh2021not,zhang2022use,nguyen2022adaptive}, where examples belonging to the same label in the mini-batch are regarded as positive examples to compute additional contrastive losses. 
\begin{figure}
    \centering
