...
\newcommand{\robby}[1]{\textcolor{blue}{\hl{RT: #1}}}
\newcommand{\robbyhl}[2]{\hl{#1} \textcolor{red}{(RT: #2)}}
...
\begin{figure}[t!]
	...
	\rotatebox{90}{\phantom{z}\textbf{(a) Self}}\hspace{0.02cm}
	...
	\setcounter{subfigure}{0}
	\rotatebox{90}{ \phantom{z}\textbf{(b) Soft}}\hspace{0.02cm}
	...
	\setcounter{subfigure}{0}
	\rotatebox{90}{ \phantom{z}\textbf{(c) Hard}}\hspace{0.02cm}
	...
	\subfloat[SG~\shortcite{wan2022sg}]{\includegraphics[width=0.233\columnwidth]{fig/SRD/IMG_6602/eccv22.png}}\hfill
	\subfloat[G2R~\shortcite{liu2021from}]{\includegraphics[width=0.233\columnwidth]{fig/SRD/IMG_6602/g2r21.png}}\hfill\\
...
In this paper, we introduce {\it DeS3}, a diffusion-based method that removes hard, soft, and self shadows from a single image using adaptive attention and ViT similarity.
%
...
%
These methods use Conditional GAN~\cite{isola2017image}, StyleGAN~\cite{karras2019style} or Uformer~\cite{guo2023shadowformer,wang2022uformer} as their architecture.
%
...
\begin{figure}[t!]
	\centering
	\captionsetup[subfigure]{labelformat=empty}
	{\includegraphics[width=0.48\textwidth]{fig/a.pdf}}
...
\begin{figure}[t!]
	...
	\captionsetup[subfigure]{font=small, labelformat=empty}
	\setcounter{subfigure}{0}
	\rotatebox{90}{ \phantom{zzz}{Input}}\hspace{0.02cm}
	...
	\setcounter{subfigure}{0}
	\rotatebox{90}{ \phantom{z}{ViT Key}}\hspace{0.02cm}
	...
	\setcounter{subfigure}{0}
	\rotatebox{90}{ \phantom{z}{Output}}\hspace{0.02cm}
...
\begin{figure}[t]
	\centering
	\captionsetup[subfigure]{labelformat=empty}
	{\includegraphics[width=0.49\textwidth]{fig/nogt.pdf}}
	\caption{In our reverse sampling process, we use the loss function to guide the output to follow the ViT similarity.}
	\label{fig:chself}
\end{figure}
...
\begin{table}[t!]
	...
	\caption{Quantitative results on the SRD dataset. S, NS and ALL represent shadow, non-shadow and entire regions. M shows ground truth shadow masks are also used in training.}
	%
	...
	\resizebox{0.48\textwidth}{!}{
		\begin{tabular}{l|c|ccc|ccc|ccc}
			...
			%\hline
			%Input Image                  &- & 36.69 & 4.83 & 14.05 & 18.96 & 31.47 & 18.19 & 0.871 & 0.975 & 0.829 \\
			\hline			
			...
			SG~\shortcite{wan2022sg} &P+M & 7.53 &3.08 &4.33 & 33.88 &36.43 & 31.38 &0.981 &0.987 &0.959\\
			S.Diff.~\shortcite{guo2023shadowdiffusion}&P+M   & 4.98 & 3.44 & 3.63 &{38.72} &37.78 & \textbf{34.73} & 0.987 & 0.985 & \textbf{0.970}\\\hline
			...
			WeaDiff~\shortcite{ozdenizci2023restoring}&P   & - & - & - &33.38 &31.15 & 28.45 & 0.981 & 0.972 & 0.951\\\hline
			DSC \shortcite{hu2019direction}          &P   & 8.81 & 4.41 & 5.71 & 30.65 & 31.94 & 27.76 & 0.960 & 0.965 & 0.903 \\
			%DeSh~\shortcite{qu2017deshadownet}&P   & 11.79& 4.84 & 6.64 & - & - & - & - & - & -\\\hline
			Ours &P &\textbf{4.70} & \textbf{2.72} & \textbf{3.59} &\textbf{38.73} &\textbf{38.12} &{34.19} &\textbf{0.987} &\textbf{0.988} &{0.968}\\\bottomrule
...
\begin{table}
	...
	\caption{User study on the self shadow removal of the UIUC dataset~\cite{guo2011single}, our method obtained the highest mean (the max score is 10), showing our method is effective in shadow removal and visually realistic. The best results are in {\bf bold}, the second best are in \underline{underline}.}
	\resizebox{0.48\textwidth}{!}{
		\begin{tabular}{l|c|c|c|c|c|c|c}\hline 
Aspects &Ours &S.Diff. &SG &G2R &SP+M+I &DC &SP+M \\\hline 
1.DeShadow$\uparrow$  &\textbf{8.6$\pm$1.3} &5.8$\pm$3.9&\underline{6.2$\pm$2.7} &5.6$\pm$3.8 &6.0$\pm$4.0 &5.4$\pm$1.8 &5.6$\pm$2.3 \\\hline
2.Realistic$\uparrow$   &\textbf{9.0$\pm$0.9} &6.9$\pm$2.8 &6.9$\pm$2.0 &\underline{7.2$\pm$3.2} &7.0$\pm$1.5 &6.0$\pm$0.5 &6.6$\pm$1.8 \\\hline
	\end{tabular}}
	\label{tb:tb_user}
\end{table}
...
\begin{figure}[t]
	...
	\subfloat[G2R]{\includegraphics[width = 0.078\textwidth]{fig/AISTD/117-1/g2r21.png}}\hfill
	\subfloat[SP+M+I]{\includegraphics[width = 0.078\textwidth]{fig/AISTD/117-1/pami21.png}}\hfill
	\subfloat[SG]{\includegraphics[width = 0.078\textwidth]{fig/AISTD/117-1/eccv22.png}}\hfill
	\subfloat[DC]{\includegraphics[width = 0.078\textwidth]{fig/AISTD/117-1/iccv21.png}}\hfill\\
	\setcounter{subfigure}{0}
	...
	\subfloat[G2R]{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6160/g2r21.png}}\hfill
	\subfloat[BM]{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6160/cvpr22.png}}\hfill
	\subfloat[SG]{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6160/eccv22.png}}\hfill
	\subfloat[DC]{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6160/iccv21.png}}\hfill
...
\begin{table}[t]
	\centering
	\renewcommand{\arraystretch}{1.2}
	\caption{RMSE (lower is better) on the AISTD dataset.}
	...
	%\resizebox{0.48\textwidth}{!}{
		\begin{tabularx}{\columnwidth}{ l|c|Y|Y|Y }
			...
			\hline
			MaskS.GAN~\shortcite{hu2019mask}   &UP &5.3 &12.5 &4.0\\
			DC~\shortcite{jin2021dc} 	   &UP &4.6 &10.3 &3.5\\
			LG~\shortcite{liu2021shadow}  &UP &4.4 &9.9 &3.4\\
			\hline
			Yang~\textit{et al.} \shortcite{Yang12}     &-        &16.0 &24.7 &14.4\\
			Gong~\textit{et al.} \shortcite{Gong14}     &-        &-  &13.3 &-\\
			wSP+M-Net~\shortcite{le2020shadow}      &M     &4.1  &9.7 &3.0\\
			G2R~\shortcite{liu2021shadow}    &M     &3.9  &8.8 &{2.9}\\
			\hline
			Guo~\textit{et al.} \shortcite{Guo11}      &P+M &6.1  &22.0 &3.1\\
			ST-CGAN~\shortcite{wang2018stacked}        &P+M &8.7 &13.4 &7.9\\
			DHAN~\shortcite{cun2020towards}            &P+M &7.9 &11.4 &7.2\\
			Auto~\shortcite{fu2021auto}       &P+M &4.2 &6.5 &3.8\\
			SP+M-Net~\shortcite{le2019shadow}          &P+M &3.9 &7.9 &3.1\\
			SP+M+I-Net~\shortcite{le2021physics}       &P+M &3.6 &\underline{6.0} &3.1\\
			BMNet \shortcite{zhu2022bijective}      &P+M &\underline{3.5} &6.1 &{2.9}\\
			SG~\shortcite{wan2022sg}                &P+M &\underline{3.5} &\underline{6.0} &3.1\\
			\hline
			Deshadow~\shortcite{qu2017deshadownet}  &P   &7.6 &15.9 &6.0\\
			SP+M-Net~\shortcite{le2019shadow}          &P &4.0  &8.2 &3.3\\
			SP+M+I-Net~\shortcite{le2021physics}       &P   &4.0 &6.6 &3.5\\\hline
			Ours                                   &P &\bf{2.8} &\bf{4.9} &\bf{2.7}\\
			\bottomrule
	\end{tabularx}}	
	\label{tb:aistd}
\end{table}
...
\begin{figure}[t]
	...
	\captionsetup[subfigure]{font=small, labelformat=empty}
	\setcounter{subfigure}{0}
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real262/s.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real262/our.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real262/eccv22.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real262/g2r21.png}}\hfill
	%\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real262/pami21.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real262/iccv21.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real262/guo.png}}\hfill\\
	\setcounter{subfigure}{0}
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real258/s.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real258/our.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real258/eccv22.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real258/g2r21.png}}\hfill
	%\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real258/pami21.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real258/iccv21.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/object/real258/guo.png}}\hfill\\
	\setcounter{subfigure}{0}
	\subfloat[Input]{\includegraphics[width = 0.078\textwidth]{fig/object/real271/s.png}}\hfill
	\subfloat[Ours]{\includegraphics[width = 0.078\textwidth]{fig/object/real271/real271_shad.png}}\hfill
	\subfloat[SG]{\includegraphics[width = 0.078\textwidth]{fig/object/real271/eccv22.png}}\hfill
	\subfloat[G2R]{\includegraphics[width = 0.078\textwidth]{fig/object/real271/g2r21.png}}\hfill
	%\subfloat[SP+M+I~\shortcite{le2021physics}]{\includegraphics[width = 0.078\textwidth]{fig/object/real271/pami21.png}}\hfill
	\subfloat[DC]{\includegraphics[width = 0.078\textwidth]{fig/object/real271/iccv21.png}}\hfill
	\subfloat[Guo]{\includegraphics[width = 0.078\textwidth]{fig/object/real271/guo.png}}\hfill
	\setcounter{subfigure}{0}
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6466/s.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6466/our.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6466/eccv22.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6466/g2r21.png}}\hfill
	%\subfloat{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6466/pami21.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6466/iccv21.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6466/cvpr22.png}}\hfill\\
	\setcounter{subfigure}{0}
	\subfloat{\includegraphics[width = 0.078\textwidth,height=2.2cm]{fig/SRD/DSCF0466/s.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth,height=2.2cm]{fig/SRD/DSCF0466/our.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth,height=2.2cm]{fig/SRD/DSCF0466/eccv22.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth,height=2.2cm]{fig/SRD/DSCF0466/g2r21.png}}\hfill
	%\subfloat{\includegraphics[width = 0.078\textwidth,height=2.2cm]{fig/SRD/DSCF0466/pami21.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth,height=2.2cm]{fig/SRD/DSCF0466/iccv21.png}}\hfill
	\subfloat{\includegraphics[width = 0.078\textwidth,height=2.2cm]{fig/SRD/DSCF0466/cvpr22.png}}\hfill\\
	\setcounter{subfigure}{0}
	\subfloat[Input]{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6577/s.png}}\hfill
	\subfloat[Ours]{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6577/our.png}}\hfill
	\subfloat[SG]{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6577/eccv22.png}}\hfill
	\subfloat[G2R]{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6577/g2r21.png}}\hfill
	%\subfloat[SP+M+I~\shortcite{le2021physics}]{\includegraphics[width = 0.140\textwidth]{fig/SRD/IMG_6577/pami21.png}}\hfill
	\subfloat[DC]{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6577/iccv21.png}}\hfill
	\subfloat[BM]{\includegraphics[width = 0.078\textwidth]{fig/SRD/IMG_6577/cvpr22.png}}\hfill
...
%\paragraph{Baselines}
%We include SOTA supervised methods SG-ShadowNet~\cite{wan2022sg}, BMNet~\cite{zhu2022bijective}, SP+M+I-Net~\cite{le2021physics}; 
...
\begin{table}[t]
	...
	\resizebox{1\columnwidth}{!}{
		\begin{tabular}{c|c|cccc|cc|cc}
			\toprule
			Method   &Guo   &Gryka &DHAN &SP+M &MS.GAN &DC &Guo (auto) & S.Diff. &Our\\\hline
...
\begin{figure*}[t]
	...
	\subfloat[SG~\shortcite{wan2022sg}]{\includegraphics[width = 0.140\textwidth]{fig/object/DSC01538/eccv221.png}}\hfill
	\subfloat[G2R~\shortcite{liu2021from}]{\includegraphics[width = 0.140\textwidth]{fig/object/DSC01538/g2r211.png}}\hfill
	\subfloat[SP+M+I-Net]{\includegraphics[width = 0.140\textwidth]{fig/object/DSC01538/pami21.png}}\hfill
	\subfloat[DC~\shortcite{jin2021dc}]{\includegraphics[width = 0.140\textwidth]{fig/object/DSC01538/iccv211.png}}\hfill
	\subfloat[S.Diff.~\shortcite{guo2023shadowdiffusion}]{\includegraphics[width = 0.140\textwidth]{fig/object/DSC01538/0_11.png}}\hfill
...
\begin{figure}[t]
	...
	\setcounter{subfigure}{0}
	\subfloat
	{\includegraphics[width = 0.195\columnwidth,height=0.8cm]{fig/VIT/s2.png}}\hfill
	\subfloat
	{\includegraphics[width = 0.195\columnwidth,height=0.8cm]{fig/VIT/sf.png}}\hfill
	\subfloat
	{\includegraphics[width = 0.195\columnwidth,height=0.8cm]{fig/VIT/our2.png}}\hfill
	\subfloat
	{\includegraphics[width = 0.195\columnwidth,height=0.8cm]{fig/VIT/in_286.jpg}}\hfill
	\subfloat
	{\includegraphics[width = 0.195\columnwidth,height=0.8cm]{fig/VIT/22.png}}\hfill\\
	\setcounter{subfigure}{0}
	\subfloat[Input\label{fig:input}]
...
To guide our reverse sampling process to preserve and recover object/scene structure information, we propose the self-tuned ViT similarity loss.
