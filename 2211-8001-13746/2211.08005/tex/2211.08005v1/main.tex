...
\input{preprint/1.introduction.tex}
\newpage
\input{preprint/2.background.tex}
\newpage
\input{preprint/3.method.tex}
\input{preprint/4.evaluation.tex}
\newpage
\input{preprint/5.discussion.tex}
\input{preprint/6.conclusion.tex}
\newpage
{\small
\bibliography{bib}
