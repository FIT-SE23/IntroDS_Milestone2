...
As it is formulated, the above question has a negative answer. Indeed, the $\fq$-subspace of skew symmetric matrices in $\fq^{m\times m}$ is $2$-divisible (as every skew symmetric matrix has even rank), but if $m$ is odd it cannot arise from a rank metric code in $\F_{q^2}^{m/2\times m/2}$.
