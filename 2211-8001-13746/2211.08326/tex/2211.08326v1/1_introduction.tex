...
\begin{itemize}
    \item Novel contrastive learning regression loss for brain age prediction;
    \item State-of-the-art performance in brain age prediction on the OpenBHB challenge.
\end{itemize}
