...
Our trainings are implemented in PyTorch, and run on the Jean Zay supercomputer (NVIDIA V100 GPUs)\footnote{This work was granted access to the HPC resources of IDRIS under the allocation 2022-AD011013473 made by GENCI.} and on an NVIDIA A40 GPU, with a single training taking \url{~}24h.
