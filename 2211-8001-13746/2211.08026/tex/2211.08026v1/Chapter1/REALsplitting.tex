...
The following result is due to \cite{Salepci} in the smooth category.
...
Proposition \ref{R:prop} follows from Lemma \ref{EXlem:splitting}
applied to the real Lefschetz fibration from the previous section.