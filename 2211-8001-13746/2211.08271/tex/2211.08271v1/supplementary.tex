...
\title{Supplementary Material for ``Multiple-flux-quanta vortices and quasiparticle states in the two-band superconductor Pb''}
...
\begin{table}[hpb]
    ...
    \begin{tabular}{l c| c c c c c c}
        \toprule
         ...
         1& A & $0.05$ & $1.3$ & $50$ & - & $23$ & $<45$\\
         & B & $1$ & $3$ & $20$ & - & $0$ & $39$\\
         & C & $2$ & $3$ & $20$ & - & $23$ & $48$\\\hline
...
\subsection*{Supplementary Note 1: Anomalous vortices in varying magnetic fields}
...
\subsection*{Supplementary Note 2: Giant vortex}
...
\subsection*{Supplementary Note 3: Particle-hole and time-reversal symmetry}
...
\subsection*{Supplementary Note 4: Vortex at $\SI{4.3}{\kelvin}$}
...
\subsection*{Supplementary Note 5: Self-consistent calculation of $\Delta$}
