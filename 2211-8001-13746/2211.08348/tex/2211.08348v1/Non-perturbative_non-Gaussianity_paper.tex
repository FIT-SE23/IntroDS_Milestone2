...
\end{align}
where $K$, $C_c$, and $\gamma$ are parameters that control the collapse, which in general are dependent on the shape of the perturbations~\cite{Musco:2018_CC,Young:2019_CC,Germani:2018_CC,Escriva:2020_CC}. The mass distribution is then given by
\begin{align}
