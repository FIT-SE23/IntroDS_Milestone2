% Notes on computing model certainty

% https://arxiv.org/pdf/2210.03005.pdf#cite.0@MC_Dropout : For Monte-Carlo Dropout, the dropout method is applied during the prediction phase. As neurons are disabled randomly, this results in a large Gaussian sample space of different models. Therefore, each model, with differently dropped out neurons, results in a potentially different prediction. Combining the vanilla softmax prediction using the arithmetic mean produces a combined prediction confidence

% MC dropout is a Bayesian approximation {gal2016dropout} used to measure model uncertainty: "We develop tools for representing model uncertainty of existing dropout NNs – extracting information that has been thrown away so far."

% why softmax is not good enough for uncertainty measure: https://stats.stackexchange.com/questions/309642/why-is-softmax-output-not-a-good-uncertainty-measure-for-deep-learning-models

% solution: use Bayesian networks (of their approximation: MC dropout) or softmax needs to be calibrated

% calibrating softmax: https://arxiv.org/pdf/1706.04599.pdf
...
\begin{enumerate}
  \item Did you include the code, data, and instructions needed to reproduce the main experimental results (either in the supplemental material or as a URL)?
    \answerNo{}{We have included the instructions to reproduce the experiments (See Section \ref{section_methods}). We will release the source code soon.}
